...
- **Doble Toque Táctil (Mejorado):** Se ha solucionado el problema que impedía registrar correctamente el doble toque (doble click) en la píldora desde teléfonos móviles. Ahora, al hacer doble tap sobre ella, esta se "hunde" simulando estar siendo presionada y automáticamente te redirige a la pestaña "Tiempo" del proyecto correspondiente para que puedas detener o modificar el cronómetro al instante.
